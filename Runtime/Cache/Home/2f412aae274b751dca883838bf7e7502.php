      ...
      <div class="container">
          <div class="row">
              ...
              <div id="main-content-right" class="col-md-8 col-md-offset-1">
                ...
                <?php if(is_array($ARTICLES)): foreach($ARTICLES as $key=>$vo): ?><div class="content">
                      ...
                      <div class="content-body">
                              <p class="text-center content-title"><a href="/index.php/Home/ShowArticle/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></p>
              ...
              <div  id="main-content-left" class="col-md-3">
                    <div class="master-info">
                        ...
                        <p class="text-center master-email"><span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span>:<a href="https://github.com/liyang-ly/" target="_blank">github.com/liyang-ly</a></p>
                        <div id="master-sum">
          ...
          <div class="row">
              <div class="col-md-1 col-md-offset-4">
                  <button type="button" class="btn  btn-warning" onclick="getMore('HOME');return false;">
                      &nbsp;&nbsp;&nbsp;更多&nbsp;&nbsp;&nbsp;
                  </button>
              </div>
          </div>
