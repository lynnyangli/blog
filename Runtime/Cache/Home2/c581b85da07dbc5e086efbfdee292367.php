...
<div id="body-wrapper"> 
  ...
  <div id="wrapper">
   ...
   <div class="intro">感谢那些在网上分享的人们 在此与大家吐槽一些我遇到问题</div>
 ...
 <?php if(is_array($ARTICLES)): foreach($ARTICLES as $key=>$vo): ?><div class="post text">
    <div class="icon-text" style="background:#<?php echo ($vo["color"]); ?>" >
    	<h1><?php echo ($vo["C"]); ?></h1>
    </div>
    <div class="content">
    	<div class="top"></div>
    ...
    <!-- Begin Page Navi -->
    <div class="page-navi">
	<h3 class="line"><a id="get_more_bu" href="#" onclick="getMore(this);return false;" class="button blue">more</a><img id="loading_img"  src="/Home/public/img/loading.gif"/></h3>
    </div>
    <!-- End Page Navi -->
