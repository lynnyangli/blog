        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="submenu active">
                    <li><a href="/index.php/Admin/NewArticle" class="active">新建文章</a></li>
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container" id="content">
                            <form class="new_user_form inline-input" action="/index.php/Admin/DoNewArticle/" method="post"/>
                               ...
                               <select style="height:30px;" name="class">
                                  <?php if(is_array($CLASS_DATA)): foreach($CLASS_DATA as $key=>$vo): ?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                                </select>
                                ...
                                <div class="field-box">
                                    <label>描述:</label>
                                    <textarea class="span9" rows="5" name="description"></textarea>
                                </div>
