...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="index.html"><img src="<?php echo ($APP_PATH); ?>/Admin/public/img/logo.png" /></a>
        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu ">
                    ...
                    <li><a href="<?php echo ($APP_PATH); ?>/index.php/Admin/ArticleClass" class="active">文章分类</a></li>
                </ul>
            </li>
            <li  class="active">
                 <div class="pointer">
                ...
                <ul class="submenu active">
                    <li><a href="<?php echo ($APP_PATH); ?>/index.php/Admin/SetHome"  class="active">首页设置</a></li>
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">
                ...
                <div class="table-wrapper products-table section">
                    ...
                    <ul id="nav">
                        <li> <input class="span2" id="appendedInputButtons" type="text">
                            <ul>
                                <li>
                                    <div class="input-prepend">
                                        <input class="span2" id="prependedInput" type="text" placeholder="Username">
                                        <span class="add-on">关联类别</span>
