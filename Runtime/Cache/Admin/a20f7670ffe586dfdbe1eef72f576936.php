        ...
        <div class="navbar-inner">
            ...
            <ul class="nav pull-right">   
                <li class="settings hidden-phone">
                    <a href="<?php echo ($APP_PATH); ?>/index.php." role="button">
                        <i class="icon-home"></i>
                    </a>
                </li>
                <li class="settings hidden-phone">
                    <a href="<?php echo ($APP_PATH); ?>/index.php/Admin/Exit/" role="button">
        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="<?php echo ($APP_PATH); ?>/index.php/ArticleList">列表</a></li>
                    <li><a href="<?php echo ($APP_PATH); ?>/index.php/ArticleClass">分类</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <div class="table-wrapper products-table section">
                    ...
                    <div class="row-fluid">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($messages_date)): foreach($messages_date as $k=>$vaule): ?><tr>
                                    <td>
                                        <?php echo ($vaule["id"]); ?>
                                    </td>
                                    <td>
                                        <?php echo ($vaule["email"]); ?>
                                    </td>
                                    ...
                                    <td>
                                        <?php echo ($vaule["state"]); ?>
                                    </td>
                                    <td>
                                    <a href="<?php echo ($APP_PATH); ?>/index.php/Admin/MessageList/domessagelist/state/reply/id/<?php echo ($vaule["id"]); ?>">回复</a>
                                    <a href="<?php echo ($APP_PATH); ?>/index.php/Admin/MessageList/domessagelist/state/dele/id/<?php echo ($vaule["id"]); ?>">删除</a>
                                    </td>
                         ...
                         <div class="row ctrls">
                            <div class="pagination pagination-centered pagination-large">
                                <ul>
                                    <li><a href="#">&#8249;</a></li>
                                    <?php $__FOR_START_2087085650__=1;$__FOR_END_2087085650__=$sum;for($i=$__FOR_START_2087085650__;$i < $__FOR_END_2087085650__;$i+=1){ if($act == $i): ?><li><a class="active" href="<?php echo ($APP_PATH); ?>/index.php/Admin/MessageList/domessagelist/state/show/id/<?php echo ($i); ?>"><?php echo ($i); ?></a></li>
                                        <?php else: ?>
                                            <li><a href="<?php echo ($APP_PATH); ?>/index.php/Admin/MessageList/domessagelist/state/show/id/<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                                    <li><a href="#">&#8250;</a></li>
                                </ul>
                            </div>
                        </div>
