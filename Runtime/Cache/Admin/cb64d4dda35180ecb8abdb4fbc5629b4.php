        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="submenu active">
                    ...
                    <li><a href="/index.php/Admin/ArticleClass" class="active">文章分类</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">
                ...
                <div class="table-wrapper products-table section">
                    ...
                    <div class="row-fluid">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($CLASS_DATA)): foreach($CLASS_DATA as $k=>$vaule): ?><tr>
                                    <td>
                                        <?php echo ($k+1); ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                    <a href="/index.php/Admin/DoArticleClass/delete/id/<?php echo ($vaule["id"]); ?>">删除</a>
                                    </td>
                ...
                <!-- end products table -->
                <a class="btn-flat success new-product" onclick="show_add_class(); return false;">+添加分类</a>
                <div id="add_class">
                    <form action="/index.php/Admin/DoArticleClass/newclass" method="post"/>
                            <div class="field-box">
                                <label>名称:</label>
