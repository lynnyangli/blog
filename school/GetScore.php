...
$url = 'http://218.75.197.124:83/tjkbcx.aspx?xh=13408100142&xm=%C0%EE%D1%EE&gnmkdm=N121601';
getSocre($url);

function getSocre($url)
{
    $data = array(
        '__EVENTTARGET'=>'xq',
        '__EVENTARGUMENT'=>'',
    ...
    $curl_score->setOpt(CURLOPT_COOKIEFILE, $_SESSION['SessionId']);
    $curl_score->exec();
    unset($culr_score);
}